      ...
      <div class="support__wrapper container">
        <div class="support__header">
          <h4 class="support__name text-center py-2">
            Субсидия на возмещение части затрат, направленных на проведение
            комплекса агротехнологических работ, повышение уровня экологической
            безопасности сельскохозяйственного производства, а также на
          ...
          <div class="support__card__header row">
            ...
            <div class="support__buttons col">
              <img
                ...
                alt=""
              />
              <button class="btn btn-outline-primary" @click="onLoad">
                Подать заявку
              </button>
            </div>
          </div>
