<template>
    <div>
        <div class="profile__wrapper container">
            <article class="profile">
                ...
                <section class="profile__user__info">
                    ...
                    <button type="button" class="profile-user-edit btn btn-outline-primary" data-toggle="modal"
        ...
        <div class="modal fade" id="profileEdit" tabindex="-1" aria-labelledby="profileEditLabel"
             aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <form action="">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="phoneProfileEdit"
                                       value="+7(903)903-3661">
                            </div>
                            <button class="btn btn-outline-primary">+ Добавить</button>
                            <div class="mb-3">
                                <label for="socialProfileEdit" class="form-label">Социальные сети</label>
                                <input type="url" class="form-control" id="socialProfileEdit"
                                       value="+7(903)903-3661">
                            </div>
                            <button class="btn btn-outline-primary">+ Добавить</button>
