        ...
        <div class="support-card">
          ...
          <b-card no-body>
            <b-tabs pills card vertical nav-wrapper-class="col-12 col-md-4">
              ...
              <b-tab v-for="(measureInfo, index) of measure.newDescription.chapters" :key="measureInfo.name" :title="measureInfo.name">
                <b-card-text>
                  <div :id="'measure-info-chapter-description-' + String(index).padStart(4, '0')"></div>
                </b-card-text>
              </b-tab>
  ...
  methods: {
    ...
    createMeasureInfo() {
      ...
      for (let i=0; i<this.measure.newDescription.chapters.length; i++) {
        let containerId = "measure-info-chapter-description-" + String(i).padStart(4, '0');
