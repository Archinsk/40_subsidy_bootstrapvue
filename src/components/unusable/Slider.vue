<!--Разобраться с относительными путями в img-src и их конвертацией без использования вложенного темплейта с картинкой-->
<template>
  <b-carousel
    id="carousel-1"
    v-model="slide"
  ...
  >
    ...
    >
      <template #img>
        <img src="@/assets/banners/banner_21.jpg" alt="слот изображения" />
      </template>
    </b-carousel-slide>
    <b-carousel-slide
    ...
    >
      <template #img>
        <img src="@/assets/banners/banner_24.jpg" alt="слот изображения" />
      </template>
    </b-carousel-slide>
    <b-carousel-slide
    ...
    >
      <template #img>
        <img src="@/assets/banners/banner_23.jpg" alt="слот изображения" />
      </template>
    </b-carousel-slide>
  </b-carousel>
</template>
