        ...
        <div class="header__wrapper container">
            <div>
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    <div class="container-fluid"><a class="logo logo_left navbar-brand" href="https://yandex.ru"><img
                            src="@/assets/default.jpg" alt="" class="logo__image">Агрегатор мер поддержки</a>
