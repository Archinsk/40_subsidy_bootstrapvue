<template>
  <div>
    <b-form-group :label="filterData.title" v-slot="{ ariaDescribedby }">
...
<script>
export default {
  name: "MeasuresFilterExampleCheckboxesGroup",
  ...
  data() {
    return {
      ...
      options: [
        ...
        {
          text: "Деятельность профессиональная научная и техническая прочая",
          value: "8",
        },
        {
          text: "Деятельность в области спорта, отдыха и развлечений",
          value: "9",
        },
        {
          text: "10 – тип поддержки, который нам в итоге нужно найти",
          value: "10",
        },
      ],
    };
