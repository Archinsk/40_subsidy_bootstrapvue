<template>
  <div v-if="!deleted" class="card">
    <div class="card-header" :id="'heading-' + tempId">
      <h2 class="mb-0">
        <div class="d-flex">
          ...
          <button class="btn btn-icon-only_square" @click="$emit('delete-message')">
    ...
    >
      <div class="card-body">
        Статус заявления №{{ tempId }} обновлен. Подробная информация направлена
