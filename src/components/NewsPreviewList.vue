    ...
    <div>
        <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3">
            <div
                    ...
                    :key="newsItem.id"
                    :class="newsItem.importance>0 && !everythingLittle ? 'news-important col col-sm-12 col-lg-8' : 'col'"
            >
                <NewsPreviewListItem
    ...
    export default {
        ...
        methods: {
            getNews() {
                ...
                const request = this.targetUrl + "?page=" + this.page + "&pageSize=" + this.newsItemTotal;
