<template>
    ...
    <div class="card measure__card">
        <div class="card-body row">
            <router-link :to="measure.measure_link" class="measure-link col-12 col-md-9 stretched-link">
                <h5 class="card-title">
            ...
            <div class="card-text col-12 col-md-3">
                Приём заявок<br>
                <b>с {{ measure.open_date }} по {{ measure.close_date }}</b>
            </div>
        </div>
        <hr>
        <div class="card-footer bg-transparent measure__card__footer row">
            <div class="measure__owner__logo col-md-6 col-lg-5">
                <img :src=" 'images/initiators_logo/' + measure.initiator_logo" class="measure__owner__logo__image"
                     alt="...">
            ...
            <div class="measure__details col-md-6 col-lg-3">
                <div class="measure__size">
                    <div class="measure__size__header">{{ measure.measure_size==='нф' ? 'Нефинансовая мера поддержки' :
                        'Размер поддержки' }}
                    </div>
                    <div v-show="measure.measure_size!=='нф'" class="measure__size__value">до {{ measure.measure_size }}
                        рублей
                    </div>
                </div>
            </div>
            <div class="measure__buttons col">
                <img v-show="measure.electronic_form === '1'" class="measure__web__accessibility"
